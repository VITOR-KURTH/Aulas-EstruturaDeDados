# conceito de filas circulares

# variante da fila comum
# usa um array fixo e reaproveita espaços vazios
# operações de inserção/remoção são feitas de forma circular
# coloca em um espaço já usado
...
filaDeckJog = FilaCartasCircular(4)
filaDeckOp = FilaCartasCircular(4)

while pilhaJogador.size() > 4:
    cartaPegada = pilhaJogador.baralho.pop()
    filaDeckJog.enqueue(cartaPegada)

while pilhaOponente.size() > 4:
